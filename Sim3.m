function [PLdata, PLVoIP, APDdata, APDVoIP, MPDdata, MPDVoIP, TT] = Sim3(lambda,C,f,P,n)
    ...
    QUEUE = [];         % Queue for storing packet size, arrival time, and type (data/VoIP)
        ...
        switch Event
            case ARRIVAL    % If first event is an ARRIVAL
                ...
                if STATE == 0
                    ...
                    if QUEUEOCCUPATION + PacketSize <= f
                        QUEUE = [QUEUE; PacketSize, Clock, PacketType];  % Enqueue packet
            ...
            case DEPARTURE    % If first event is a DEPARTURE
                ...
                if QUEUEOCCUPATION > 0
                    % Serve the next packet in the queue (FIFO)
